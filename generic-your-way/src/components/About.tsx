...
<div className="container py-4">
      <h1 className="mb-3">How to Use the Site</h1>
      ...
      <section className="mt-4">
        <h2 className="h4">2) Weekly Availability (on your Player Card)</h2>
        <ul>
        ...
        <p className="small">
          Tip: Keep your availability fresh so invites match your real schedule.
        </p>
        <div className="small">
      ...
      <section className="mt-4">
        ...
        <ul>
          <li>Open <strong>Find Players</strong> and use filters:
            <ul>
      ...
      <section className="mt-4">
        <h2 className="h4">5) Track Invites (Dashboard)</h2>
        <ul>
          <li><strong>Incoming invites</strong> — requests you received.</li>
          <li><strong>Outgoing (pending)</strong> — requests you sent.</li>
        </ul>
        ...
        <div className="small">
          Go to <Link to="/">Home (Dashboard)</Link>
        </div>
      </section>
      ...
      <section className="mt-4">
        ...
        <p>
          This isn’t just a finder—it’s a community tool to connect local players, organize games and campaigns, and encourage friendly play and knowledge sharing.
        </p>
      </section>
      ...
      <section className="mt-4">
        ...
        <p className="text-warning">Turn on <strong>Busy All Week</strong> in your Player Card.</p>
